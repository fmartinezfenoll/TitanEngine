#version 450 core
// Lighting-component demo: DIFFUSE (Lambert) term only.
in vec3 FragNormal;
...
// Direction from the fragment toward a light, plus its distance attenuation.
...
void main()
{
    ...
    for (int i = 0; i < count; ++i)
    {
        ...
        // Lambert: brightness proportional to the cosine of the angle between
        // the surface normal and the light direction. This is what gives the
        // sense of volume, but with no highlight it looks matte.
